...
<div>
    <table align="left">
        <tr><td>Pays</td></tr>
        <?php
// Supporte l'ajout d'une couleur dans l'array sans autre modification
  $colors = ['blue', 'white', 'red', 'green', 'black'];
  $nb2 = count($colors);
  for($i=0;$i<$nb;$i++){
    // affichage de la ligne avec la couleur
    echo "<tr><td style='background-color: " . $colors[$i%$nb2] . "'>$donnees[$i]</td></tr>";
  }
?>
    </table>
</div>
